...
if ($_SERVER['HTTP_HOST'] != "demos.aysmedia.com") {
	...
	$sql = "insert into _dw_whm_accounts (domain, ip, owner, user, email, disklimit, diskused, partition, maxaddons, maxftp, maxlst, maxparked, maxpop, maxsql, maxsub, plan, theme, shell, startdate, unix_startdate, suspended, suspendreason, suspendtime) VALUES
			...
			('account-no-zone-1.com', '69.167.168.206', 'root', 'anz1', 'privacy@aysmedia.com', 'unlimited', '1M', 'home', '*unknown*', 'unlimited', 'unlimited', '*unknown*', 'unlimited', 'unlimited', 'unlimited', 'Unlimited', 'x3', '/usr/local/cpanel/bin/noshell', '2010 Jul 22 15:39', 1269089019, '0', 'not suspended', 'null'),
			('account-no-zone-2.com', '69.167.168.206', 'root', 'anz2', 'privacy@aysmedia.com', 'unlimited', '1M', 'home', '*unknown*', 'unlimited', 'unlimited', '*unknown*', 'unlimited', 'unlimited', 'unlimited', 'Unlimited', 'x3', '/usr/local/cpanel/bin/noshell', '2010 Jul 22 15:39', 1269089018, '0', 'not suspended', 'null');";
	$result = mysql_query($sql,$connection) or die(mysql_error());
